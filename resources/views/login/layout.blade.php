...
<main class="main" id="top">
    <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6">
            <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-4" href="../../../index.html"><img class="me-2" src="../../../assets/img/icons/spot-illustrations/falcon.png" alt="" width="58" /><span class="font-sans-serif text-primary fw-bolder fs-5 d-inline-block">Садоводство</span></a>
                <div class="card">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <form >
                            @csrf
                            <div class="mb-3">
                                <input class="form-control" type="email" placeholder="Номер телефона" />
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="password" placeholder="Код подтверждения" />
                            </div>
